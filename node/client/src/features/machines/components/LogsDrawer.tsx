...
export function LogsDrawer({ isOpen, onClose, machineId }: LogsDrawerProps) {
    ...
    return (
        <div
            ref={drawerRef}
            className={cn(
                "fixed bottom-0 left-0 right-0 border-t border-border bg-background transition-all duration-300 ease-in-out z-40 shadow-[0_-5px_20px_rgba(0,0,0,0.1)] flex flex-col",
