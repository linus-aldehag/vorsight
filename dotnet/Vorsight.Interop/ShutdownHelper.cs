...
/// </summary>
public class ShutdownHelper(ILogger<ShutdownHelper> logger, IProcessHelper processHelper)
    : IShutdownHelper
{
    /// <summary>
    ...
    public bool TryLogoffSession(uint sessionId, bool wait = true)
    {
        ...
        {
            logger.LogError(ex, "TryLogoffSession failed");
            return false;
        }
    }
    ...
    public bool TryForceLogoff()
    {
        ...
        {
            logger.LogError(ex, "TryForceLogoff failed");
            return false;
        }
    }
    ...
    public bool TryForceLogoffInteractiveUser()
    {
        try
        {
            ...
            {
                logger.LogInformation("No active console session found - no user logged in");
                return false;
            }
            ...
            if (sessionId == 0)
            {
                logger.LogWarning("Active console session is 0 (services) - unexpected");
                return false;
            }

            logger.LogInformation("Logging off active console session: {SessionId}", sessionId);
        ...
        {
            logger.LogError(ex, "TryForceLogoffInteractiveUser failed");
            return false;
        }
    }
    ...
    )
    {
        ...
        {
            logger.LogError(ex, "TryInitiateShutdown failed");
            return false;
        }
    }
    ...
    public bool TryAbortShutdown()
    {
        ...
        {
            logger.LogError(ex, "TryAbortShutdown failed");
            return false;
        }
    }
    ...
    public bool TryLockWorkstation()
    {
        ...
        {
            logger.LogError(ex, "TryLockWorkstation failed");
            return false;
        }
    }
    ...
    public bool TryGetSessionIdForProcess(uint processId, out uint sessionId)
    {
        ...
        {
            logger.LogError(ex, "TryGetSessionIdForProcess failed");
            return false;
        }
    }
}
