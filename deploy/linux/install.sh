#!/bin/bash
# Vorsight Server Installation Script for Raspberry Pi
# This script installs the Vorsight server as a systemd service
...
echo -e "${CYAN}🚀 Vorsight Server Installation${NC}"
echo ""
...
if ! command -v npm &> /dev/null; then
    ...
    echo -e "${YELLOW}   Run: curl -fsSL https://deb.nodesource.com/setup_18.x | sudo -E bash - && sudo apt-get install -y nodejs${NC}"
    exit 1
fi
